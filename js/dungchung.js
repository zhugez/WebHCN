...
function addHeader() {
  document.write(`        
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ The Camera Store" title="Trang chủ The Camera Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html">The Camera Store</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">32-group</span></p>
    </div>`);
}
    ...
    s.innerHTML = `
			(function () {
				...
				for (var li of li_s) {
					...
					switch (loai) {
						case "Màn hình:":
							result.detail.manHinh = giatri.replace('"', "'");
							break;
						case "Hệ điều hành:":
